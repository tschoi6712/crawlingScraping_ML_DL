...
# 파일 경로 지정하기
root_dir = "D:/1.Workspace/1.Python_ws/2_3.MachineDeepLearningPython/ch7"
search_dir = root_dir + "/image/101_ObjectCategories"
cache_dir = root_dir + "/image/cache_avhash"
# 파일 경로 지정하기
